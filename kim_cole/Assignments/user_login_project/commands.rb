...
u = User.new(first_name: "Kim", last_name: "Cole", email_address: "kimcole@email.com", age: 46)
u.save
User.create(first_name: "Steve", last_name: "Cole", email_address: "stevecole@email.com", age: 35)
User.create(first_name: "Aly", last_name: "Kokjohn", email_address: "alykokjohn@email.com", age: 25)
User.create(first_name: "Sammy", last_name: "Kokjohn", email_address: "sammykokjohn@email.com", age: 21)
User.create(first_name: "Jessie", last_name: "Kokjohn", email_address: "jessiekokjohn@email.com", age: 19)
...
u = User.find(3)
u.update(last_name: "Abrakadabra")
