...
# 1. Create 5 users
User.create(first_name: "Kim", last_name: "Cole", email: "kimcole@dojo.com")
User.create(first_name: "Steve", last_name: "Cole", email: "stevecole@dojo.com")
User.create(first_name: "Jessica", last_name: "Kokjohn", email: "jessicakokjohn@dojo.com")
User.create(first_name: "Sammy", last_name: "Kokjohn", email: "sammykokjohn@dojo.com")
User.create(first_name: "Aly", last_name: "Kokjohn", email: "alykokjohn@dojo.com")
...
#------------
#Polymorphism Assignment - add onto Blogger Assignment
...
Comment.create(content: "This is a comment on the eigth message", commentable: Message.find(8))
Comment.create(content: "Another comment on the eigth message", commentable: Message.find(8))
