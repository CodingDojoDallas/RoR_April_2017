...
# retrieve the first_name of the ninjas that belong to the first dojo and order the result by created_at DESC order
# Dojo.first.ninjas.select(:first_name).order(created_at: :desc)
